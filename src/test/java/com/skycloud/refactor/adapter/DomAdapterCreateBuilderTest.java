...
import com.skycloud.refactor.creative.builder.DomAdapterBuilder;
import com.skycloud.refactor.creative.builder.OrdersWriterDomAdapterBuilderRefactor;
...
public class DomAdapterCreateBuilderTest {
...
//		orders.add(order);
	...
	public void testOrderWriter(){
		...
		order.Add(p);
		list.add(order);
		OrdersWriterDomAdapterBuilderRefactor refactor = new OrdersWriterDomAdapterBuilderRefactor(list);
